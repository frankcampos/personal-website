    ...
    <div className="relative top-10 flex justify-center items-center">
      <div className="max-w-4xl w-ful flex flex-col md:flex-row">
        ...
        <div className="flex-1 p-6">
          ...
          <button onClick={handleDownloadResume} className="mt-6 bg-tennessee-orange hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 rounded inline-flex items-center">
